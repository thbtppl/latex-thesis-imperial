...
\newcommand*{\dottedblackline}  {\tikz[baseline=\cbaseline]\draw[line width=\clinewidth, color=ThesisBlack,    dotted]         (0,0) -- (\clinelength,0);}
\newcommand*{\dashedredline}    {\tikz[baseline=\cbaseline]\draw[line width=\clinewidth, color=ThesisRed,      densely dashed] (0,0) -- (\clinelength,0);}
\newcommand*{\dashedblueline}   {\tikz[baseline=\cbaseline]\draw[line width=\clinewidth, color=ThesisBlue,     densely dashed] (0,0) -- (\clinelength,0);}
...
\newcommand*{\bluecross}           {\tikz{\node[draw=ThesisBlue,        scale=0.7,cross out]                                                                  () {};}}
...
% removes the need of adding '\centering' for each figure
